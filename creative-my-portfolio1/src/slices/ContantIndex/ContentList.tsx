...
type ContentListProps = {
  ...
  contentType: Content.ContantIndexSlice["primary"]["contant_type"];
  fallbackItemImage: Content.ContantIndexSlice["primary"]["fallback_item_image"];
  viewMoreText: Content.ContantIndexSlice["primary"]["view_more_text"];
};
